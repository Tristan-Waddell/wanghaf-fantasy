...
const locksAt = new Date("2026-09-17T23:00:00.000Z");
...
test("a week is open from Monday through the Thursday cutoff", () => {
  ...
  assert.equal(getWeekStatus(startsAt, locksAt, new Date("2026-09-17T22:59:59Z")), "open");
});

test("a week locks exactly at Thursday 7 PM New York time", () => {
